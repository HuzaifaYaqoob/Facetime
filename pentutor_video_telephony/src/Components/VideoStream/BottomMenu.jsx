...
const MenuBlock = (props) => {
    ...
    const share_video_handler = () => {
        let user_stream = props.user.stream.media
    ...
    console.log(props.user.stream.media.getAudioTracks()[0]?.enabled)
    return (
        <>
            <div className="min-h-[100px] bg-[#f1f4f9] rounded-3xl flex items-center justify-center gap-8 py-3 px-8">
                <MenuIcon
                    icon={
                        <>
                            <svg width="28" height="28" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    className={`${props.user.stream.media.getVideoTracks()[0]?.enabled ? 'fill-black' : 'fill-white'}`}
                    ...
                    active={props.user.stream.media.getVideoTracks()[0]?.enabled}
                />
                <MenuIcon
                    icon={
                        <>
                            <svg width="20" height="27" viewBox="0 0 23 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    className={`${props.user.stream.media.getAudioTracks()[0]?.enabled ? 'fill-black' : 'fill-white'}`}
                    ...
                    active={props.user.stream.media.getAudioTracks()[0]?.enabled}
                />
                <MenuIcon
                    icon={
                        <>
                ...
                <MenuIcon
                    icon={
                        <>
                            <svg width="28" height="27" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <MenuIcon
                    icon={
                        <>
                            <svg width="23" height="24" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
